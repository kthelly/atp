...
public class Exercicio01 {
	...
	public static void main(String[] args) {
		...
		// notaSemestre (0 a 70 pontos), notaPfinal (30 pontos) e notaEespecial (30 pontos).
		...
		if (frequencia >= 0.75) { // O aluno deve obter pelo menos 75% de frequência
			...
			if (notaSemestre >=30) { //O aluno deve alcançar pelo menos 30 pontos no semestre para poder ir para a prova final. 
				System.out.println("Digite a nota da prova final:");
				notaPfinal = sc.nextDouble();
				notaTotal = notaSemestre + notaPfinal;
				
				/* 
				 * A nota do semeste + prova final deve ser superior ou igual a 60 pontos.
				 * Caso o aluno não obtenha a média com a prova final, o aluno fará um exame 
				 * especial que substituirá a prova final. 
				 */
				if (notaTotal < 60) { 
					...
					if(notaTotalesp >=60) { //A nota do semeste + exame especial deve ser superior a 60 pontos.
						System.out.println("O aluno foi aprovado na disciplina " + codigo + " com a nota final de: " + notaTotalesp); 
					}else {
						System.out.println("O aluno foi reprovado na disciplina " + codigo + " por nota."); 
					}
				}else {
					System.out.println("O aluno foi aprovado na disciplina " + codigo + " com a nota final de: " + notaTotal); 
				}
			}else {
				System.out.println("O aluno foi reprovado na disciplina " + codigo + " por nota."); 
			}
